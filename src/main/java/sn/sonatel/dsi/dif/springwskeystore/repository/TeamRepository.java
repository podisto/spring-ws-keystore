package sn.sonatel.dsi.dif.springwskeystore.repository;

import org.springframework.stereotype.Component;
import sn.sonatel.dsi.dif.springwskeystore.wsdl.Team;
...
public class TeamRepository {
    ...
    public Team findByCountryCode(String countryCode) {
        Objects.requireNonNull(countryCode, "Country Code should not be null");
